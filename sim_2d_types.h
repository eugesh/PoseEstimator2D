...
static const INT ROI_MARGIN=2;
static const INT ROI_STEP=1;
#define BLOCK_SIZE 500
static const float PITCH_STEP=1.0f; // [degree]
static const float ROLL_STEP=1.0f; // [degree]
static const float YAW_STEP=1.0f; // [degree]
